...
| P5 | 400×400 PNG logo + demo video/GIF | Cline marketplace, Product Hunt, PH-style venues | ✅ logo (`assets/brand/logo-400.png`); demo GIF (`assets/demo/mcp-demo.gif`, embedded in README) |
